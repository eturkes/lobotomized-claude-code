...
-->
runs ${TOOL_RESULT_BASH_WORKTREE_GIT_WRAPPER_BEFORE_GIT_VAR_0.basename(TOOL_RESULT_BASH_WORKTREE_GIT_WRAPPER_BEFORE_GIT_VAR_1)} before a git command, whose string payload can't be verified to leave the worktree alone

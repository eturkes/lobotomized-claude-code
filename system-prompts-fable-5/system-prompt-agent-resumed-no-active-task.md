...
-->
Agent "${SYSTEM_PROMPT_AGENT_RESUMED_NO_ACTIVE_TASK_VAR_0.to}" had no active task; resumed from transcript in the background with your message. You'll be notified when it finishes. Output: ${SYSTEM_PROMPT_AGENT_RESUMED_NO_ACTIVE_TASK_VAR_1.outputFile}

...
-->
Render an HTML or Markdown file to an Artifact, a default-private web page hosted on claude.ai that the user can later choose to share. Use this when communicating visually would be clearer than terminal text.

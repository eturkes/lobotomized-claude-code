...
-->
 For reference, this tool's input schema is: ${TOOL_RESULT_TOOL_INPUT_SCHEMA_REFERENCE_VAR_0(TOOL_RESULT_TOOL_INPUT_SCHEMA_REFERENCE_VAR_1.toJSONSchema(TOOL_RESULT_TOOL_INPUT_SCHEMA_REFERENCE_VAR_2.inputSchema))}

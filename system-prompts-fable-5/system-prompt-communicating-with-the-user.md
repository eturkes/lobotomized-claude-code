...
description: >-
  Inter-tool-call communication and response-length calibration. This is the arm
  the fableMythosPromptSet patch routes to (W1e forced true), so it is the only
  comms block that actually renders.
ccVersion: 2.1.169
variables:

...
description: >-
  ...
  this id is now only the ADs()-false branch string feeding `t`. The claim
  (confirm before hard-to-reverse/outward-facing actions; approval doesn't carry
  across contexts) is covered by the deployed

...
ccVersion: 2.1.211
-->
This project cannot hold a durable write grant for this account (it may be shared from another organization, or not viewable) — use finalize_plan with writes/deletes and pass the returned plan_token.

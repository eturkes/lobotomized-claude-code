<!--
name: 'Skill: Prototype when_to_use'
description: >-
  The `when_to_use` frontmatter of the bundled prototype skill, telling the
  model to offer prototyping unprompted at most once per session and exactly
  when that offer is appropriate.
ccVersion: null
-->

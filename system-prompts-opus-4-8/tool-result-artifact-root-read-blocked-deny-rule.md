...
-->
root: reading from under ${TOOL_RESULT_ARTIFACT_ROOT_READ_BLOCKED_DENY_RULE_VAR_0.stringify(TOOL_RESULT_ARTIFACT_ROOT_READ_BLOCKED_DENY_RULE_VAR_1)} is blocked by a Read permission rule

<!--
name: 'Skill: /morning slash command'
description: >-
  Renders a concise styled morning brief from connected calendar and
  communication sources or configures it as a recurring weekday task; the
  MORNING_BRIEF_PROMPT injected as model instructions.
ccVersion: 2.1.210
-->
## Context

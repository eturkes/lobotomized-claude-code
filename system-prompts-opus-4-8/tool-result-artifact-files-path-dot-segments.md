...
-->
files: published path ${TOOL_RESULT_ARTIFACT_FILES_PATH_DOT_SEGMENTS_VAR_0.stringify(TOOL_RESULT_ARTIFACT_FILES_PATH_DOT_SEGMENTS_VAR_1)} contains "." or ".." segments — pass the plain served path

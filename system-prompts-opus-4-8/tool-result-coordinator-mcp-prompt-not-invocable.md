...
-->
"/${TOOL_RESULT_COORDINATOR_MCP_PROMPT_NOT_INVOCABLE_VAR_0.name}" is an MCP prompt and cannot run in coordinator mode: the coordinator does not load prompt content, and workers cannot invoke MCP prompts via the ${TOOL_RESULT_COORDINATOR_MCP_PROMPT_NOT_INVOCABLE_VAR_1} tool.

...
description: >-
  ...
  the findings payload plus the optional --fix and launch-note suffixes.
ccVersion: 2.1.218
variables:
...
${SYSTEM_REMINDER_CLOUD_REVIEW_FINDINGS_TRAILING_VAR_0}${SYSTEM_REMINDER_CLOUD_REVIEW_FINDINGS_TRAILING_VAR_1}${SYSTEM_REMINDER_CLOUD_REVIEW_FINDINGS_TRAILING_VAR_2}

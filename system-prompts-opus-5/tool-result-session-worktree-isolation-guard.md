...
-->
This session is now isolated in ${TOOL_RESULT_SESSION_WORKTREE_ISOLATION_GUARD_VAR_0.worktreePath}. Edit the worktree copy of this file instead of the shared-checkout path.${TOOL_RESULT_SESSION_WORKTREE_ISOLATION_GUARD_VAR_1(TOOL_RESULT_SESSION_WORKTREE_ISOLATION_GUARD_VAR_2,TOOL_RESULT_SESSION_WORKTREE_ISOLATION_GUARD_VAR_3,TOOL_RESULT_SESSION_WORKTREE_ISOLATION_GUARD_VAR_0.worktreePath)}

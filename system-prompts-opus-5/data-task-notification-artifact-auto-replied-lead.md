<!--
name: Artifact Auto-Replied Notice (Lead)
description: >-
...
Auto-replied to thread ${DATA_TASK_NOTIFICATION_ARTIFACT_AUTO_REPLIED_LEAD_VAR_0.id} on artifact ${DATA_TASK_NOTIFICATION_ARTIFACT_AUTO_REPLIED_LEAD_VAR_1}. 

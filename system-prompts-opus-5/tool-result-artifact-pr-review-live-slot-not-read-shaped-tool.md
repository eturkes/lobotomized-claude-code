<!--
name: PR Review Live Slot Not A Read-Shaped Tool
description: >-
  k9o() manifest-validation failure telling Claude the live read slot must name
  a read-shaped connector tool (get_/list_/search_ prefix or *_read suffix).
ccVersion: null
-->
